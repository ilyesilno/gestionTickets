      ...
      <div>
        ...
        <ul class="space-y-2 text-base font-semibold">
          ...
          <li
            ...
            {{ in_array(request()->route()->getName(), ['client-list-tickets', 'edit-client-ticket', 'search-client-tickets', 'show-client-ticket']) ? 'bg-cyan-200 text-cyan-800' : '' }}">
            <a href="{{ route('client-list-tickets') }}" class="flex items-center gap-3">
